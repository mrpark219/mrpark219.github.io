...
description: Blocking I/O와 Non-Blocking I/O의 차이, 멀티스레드와 Spring MVC/WebFlux의 관계를 예제 코드로 비교.
categories: [백엔드]
tags: [백엔드, 동시성, io]
...
![IntelliJ에서 Spring WebFlux 예제 프로젝트를 생성하는 화면](/assets/blog-images/posts/2025-03-11-blocking-vs-non-blocking-io/2025-03-12-15-37-20.png)
...
![IntelliJ에서 새 모듈을 추가하는 메뉴 화면](/assets/blog-images/posts/2025-03-11-blocking-vs-non-blocking-io/2025-03-12-15-38-56.png)

1. 생성된 `Empty Project`를 우클릭하고 `New` -> `Module`를 클릭한다.

![Spring Boot 모듈 생성 화면에서 api-server-1 정보를 입력하는 화면](/assets/blog-images/posts/2025-03-11-blocking-vs-non-blocking-io/2025-03-12-15-36-14.png) 2. SpringBoot를 클릭하고 Name에 `api-server-1`을 입력한다. Language는 `Java`, Type은 `Gradle-Groovy`를 선택한다.

![Spring Reactive Web 의존성을 선택하는 화면](/assets/blog-images/posts/2025-03-11-blocking-vs-non-blocking-io/2025-03-12-15-41-20.png) 3. `Spring Reactive Web` 의존성을 추가해준다.

![Spring WebFlux 예제 프로젝트 생성 완료 화면](/assets/blog-images/posts/2025-03-11-blocking-vs-non-blocking-io/2025-03-12-15-42-21.png)
